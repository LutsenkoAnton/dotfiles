return {
    {
        ...
        keys = {
            ...
            { '<leader>db',  function() require('dap').toggle_breakpoint() end,                                              desc = "Toggle Breakpoint, c - set condition, l - log message" },
            { '<leader>dbc', function() require('dap').set_breakpoint(vim.fn.input('Breakpoint condition: '), nil, nil) end, desc = "Breakpoint on condition" },
            { '<leader>dbl', function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end,    desc = "Breakpoint with log message" },
            {
                '<leader>dbcl',
                function()
            ...
            { '<leader>dl', function() require('dap').run_last() end,  desc = "Restart debug session" },
        },
        dependencies = {
            {
