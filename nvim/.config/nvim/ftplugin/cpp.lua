function RunCppFile()
    ...
    vim.cmd.write()
    vim.cmd("TermExec direction=float  dir=" .. dir .. " cmd='clear && clang++ -fsanitize=undefined -g -Wall -std=c++20 " .. full_filename .. " ; echo \\\"\\\\e[32mBuild completed\\\\e[0m\\\" && ./a.out ; rm -rf ./a.out*'")
